...
describe("client_socket_event_publish_limits", () => {
  it("computes envelope upper bound from payload + attachment budget", () => {
    ...
    expect(envelope).toBe(512 * 1024 + Math.min(6 * 1024 * 1024, Math.ceil((2 * 1024 * 1024 * 4) / 3) + 512 * 1024) + 64 * 1024);
  });

  it("caps raw publish JSON by Engine.IO buffer", () => {
    const raw = socketEventPublishRawJsonUpperBound(10 * 1024 * 1024, 10 * 1024 * 1024, 10 * 1024 * 1024);
