...
const envMock = {
  ...
  restClientMeAgentTokenPutRateLimitWindowMs: 60_000,
  restClientMeAgentTokenPutRateLimitMax: 20,
  restMeClientDecisionRateLimitWindowMs: 60_000,
  restMeClientDecisionRateLimitMax: 20,
...
const setupRateLimitModule = async (withRedisStore: boolean): Promise<RateLimitModuleSetup> => {
  ...
  vi.doMock("../../../../../src/application/services/rest_http_rate_limit_metrics.service", () => ({
    ...
    incrementRestHttpClientMeAgentTokenPutRateLimitRejected: vi.fn(),
    incrementRestHttpMeClientDecisionRateLimitRejected: vi.fn(),
