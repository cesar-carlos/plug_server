...
| `meta.agent_phases.*` (opt-in) | Agent sub-phases when `agentPhaseTimings` negotiated | Breaks down `agent_to_hub_ms` (frame decode, SQL queue, execute, encode) — see [ADR 0012](../adrs/0012-agent-phase-timings.md) |
