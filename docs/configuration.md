...
| `SOCKET_AGENT_HEARTBEAT_RATE_LIMIT_WINDOW_MS`     | `60000`                                          | Janela do limite de `agent:heartbeat`, isolado por socket `/agents`. `0` desativa.                                                                                                                                                                                                                                                                           |
| `SOCKET_AGENT_HEARTBEAT_RATE_LIMIT_MAX`           | `240`                                            | Maximo de heartbeats por socket na janela; corta floods antes de atualizar liveness, presence Redis e emitir ACK. `0` desativa.                                                                                                                                                                                                                              |
...
em um stream Redis por `recipient + eventName`, permitindo entrega at-least-once a
...
| `AGENT_EVENT_STREAM_MAX_LEN`                | `1000`     | `XADD MAXLEN ~` por recipient + evento.                                     |
| `AGENT_EVENT_STREAM_TTL_MS`                 | `86400000` | `PEXPIRE` aplicado por recipient + evento (24h default). `0` desliga TTL.   |
...
| `AGENT_EVENT_STREAM_DRAIN_ACK_TIMEOUT_MS`   | `5000`     | Timeout do ack por subscriber durante drain.                                |
...
| `AGENT_EVENT_STREAM_CONSUMER_CLAIM_IDLE_MS` | `5000`     | Idle minimo para recuperar PEL de outra replica com `XAUTOCLAIM`.           |
